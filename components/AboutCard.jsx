...
const AboutCard = () => {
  return (
    <div className=" w-[90%] lg:w-[70%] mx-auto bg-slate-50 rounded-3xl shadow-inner px-2 py-10 flex flex-col items-center justify-center text-center gap-4">
        <h2 className="py-4 text-[#7fafb1]">Miljø Renholdjenester AS</h2>
        <p className=' text-xl'>
